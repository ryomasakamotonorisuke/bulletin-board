      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="flex justify-between items-center mb-4">
          <div className="flex items-center gap-3">
            ...
            />
            <h1 
              className="text-2xl font-bold japanese"
              style={{ color: '#F69111' }}
            >
              社内掲示板
            </h1>
          ...
          <div className="flex items-center space-x-4">
            <button
              onClick={onNewPost}
              className="flex items-center px-6 py-3 rounded-2xl focus:outline-none focus:ring-2 transition-all duration-300 font-bold japanese shadow-lg hover:scale-105 hover:shadow-xl"
              style={{ 
              ...
              >
                ...
                >
                  {user?.avatar_url ? (
                    ...
                    <User className="w-5 h-5" style={{ color: '#011623' }} />
                  )}
                </div>
                <span className="hidden sm:block text-sm font-medium japanese" style={{ color: '#011623' }}>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex gap-2">
            <div className="relative flex-1">
              <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5" style={{ color: '#F69111' }} />
              <input
                type="text"
                placeholder="投稿を検索..."
                value={searchTerm}
                onChange={(e) => onSearchChange(e.target.value)}
                className="w-full pl-10 pr-4 py-2 border-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-yellow japanese"
                style={{ 
                  borderColor: '#FFC700',
                  borderRadius: '16px'
                }}
            ...
            <select
              ...
              className="px-4 py-2 border-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-yellow japanese"
              style={{ 
                borderColor: '#FFC700',
                borderRadius: '16px'
              }}
          ...
          <div className="flex gap-2 flex-wrap">
            <button
              ...
              className={`px-4 py-2 rounded-xl transition-all text-sm japanese font-bold ${
